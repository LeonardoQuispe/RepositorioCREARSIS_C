...
{
    public partial class inv002_01a : DevComponents.DotNetBar.Metro.MetroForm
    {
        #region VARIABLES
        ...
        public void fu_bus_car(string val_bus, int prm_bus)
        {
            ...
            tab_inv002 = o_inv002._01a(val_bus, prm_bus + 1,lventa ,lcompra );
        ...
        /// <returns></returns>
        public inv002_01a(Boolean _lventa = false, Boolean _lcompra = false)
        {
            lventa = _lventa;
            lcompra = _lcompra;
            InitializeComponent();
