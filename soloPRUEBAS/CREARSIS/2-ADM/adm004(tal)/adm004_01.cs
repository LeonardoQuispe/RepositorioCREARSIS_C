        ...
        public void fu_sel_fila(string nro_tal, string cod_doc,string nom_tal)
        {
            ...
            if (nro_tal != null)
            {
                try
                {
                    ...
                    {
                        if (dg_res_ult.Rows[i].Cells[0].Value.ToString().ToUpper() == cod_doc.ToUpper() && dg_res_ult.Rows[i].Cells[2].Value.ToString().ToUpper() == nro_tal.ToUpper() && dg_res_ult.Rows[i].Cells[3].Value.ToString().ToUpper() == nom_tal.ToUpper())
                        {
