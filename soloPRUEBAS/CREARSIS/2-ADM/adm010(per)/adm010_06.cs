...
namespace CREARSIS._2_ADM.adm010_per_
{
    public partial class adm010_06 : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void adm010_06_Load(object sender, EventArgs e)
        {
            fu_ini_frm();
        }
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            //ELIMINA datos
            o_adm010._06(tb_cod_per.Text.Trim());

            MessageBoxEx.Show("Operación completada exitosamente", "Elimina Persona", MessageBoxButtons.OK, MessageBoxIcon.Information);
