...
{
    public partial class inv002_04 : DevComponents.DotNetBar.Metro.MetroForm
    {
        #region VARIABLES
        ...
        private void inv002_04_Load(object sender, EventArgs e)
        {
            fu_ini_frm();
        }
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (err_msg != null)
                {
                    MessageBoxEx.Show(err_msg, "Error Habilita/Deshabilita Producto", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                DialogResult res_msg = new DialogResult();
                if (tb_est_ado.Text == "Habilitado")
                {
                    res_msg = MessageBoxEx.Show("¿Estas seguro de Deshabilitar el  Producto?", "Deshabilita  Producto", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                }
                else
                {
                    res_msg = MessageBoxEx.Show("¿Estas seguro de Habilitar el Producto?", "Habilita  Producto", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                }
                ...
                if (tb_est_ado.Text == "Habilitado")
                {
                    o_inv002._04(tb_cod_pro.Text, "N");
                }
                else
                {
                    o_inv002._04(tb_cod_pro.Text, "H");
                }

                MessageBoxEx.Show("Operación completada exitosamente", "Habilita/Deshabilita Producto", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBoxEx.Show(ex.Message, "Habilita/Deshabilita Producto", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
